package com.ingres.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.ingres.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.ingres.springboot.model" });
